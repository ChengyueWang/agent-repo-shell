...
3. **File → Open Folder...** → pick the shell repo → click the <img src="icon.png" width="20" alt="pet" /> icon in the editor title bar (top-right) to open the panel. *No icon?* Run `Cmd/Ctrl+Shift+P` → **Agent Repo Shell: Open View**.
